                  ...
                  decoration: BoxDecoration(
                   ...
                   child: Row(
                    ...
                    Column(
                      ...
                      children: [
                        //Powder Canister
                        HeadLine22(text: 'Powder Canister ',bold: false,),
                        10.h.heightSizedBox,
                        Row(
                          children: [
                            HeadLine22(text: '${'\$6.99'}',
                            textColor: LightAppColors.maincolorgreen400,),
                            TitleMedium(text: '${'/kg'}',textColor: LightAppColors.black,)
                          ],
                        )
                      ],
                    ),
                    Column(
                      ...
                      children: [
                        CircleAvatar(
                         ...
                         TitleMedium(text: '$number',textColor: LightAppColors.black,bold: true,),
                        CircleAvatar(
                          radius: 11,
                          backgroundColor: LightAppColors.maincolorgreen400,
                          child: IconButton(
