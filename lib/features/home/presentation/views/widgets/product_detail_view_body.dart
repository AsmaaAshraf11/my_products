                      ...
                      children: [
                        Row(
                          ...
                          children: [
                           ...
                           IconbuttonArrowBack( iconColor: Colors.white,padding: 20.0, 
                           icon: Icons.favorite,
                           buttonColor:LightAppColors.maincolorgreen700,)
                          ],
                        ),
                   ...
                   width: 180,
                    ...
                    CounterDetail()
                            ...
                            Padding(
                             ...
                             child: Center(child: HeadLine22(text:'Powder Canister' ,)),
                           ),
                           ReviewAndRating(),
                              Padding(
                                   ...
                                   DescriptionProduct(),
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                          MidButtom(text: '\$6.99', onPressed: (){},) ,
                                           MidButtom(text: 'Add Cart', onPressed: (){},)  
                ],           
              ),
          )
       ],),
