          ...
          child: Row(
            children: [
               Padding(
                 ...
                 child: Icon(Icons.location_on,color: LightAppColors.primary, ),
               ),
              Expanded(
                child: TitleMedium( fontSize: 17,
                 overflow: true,               
              ...
              PopupMenuButton(
                    ...
                    PopupMenuItem(child: Text('dalet',style: TextStyle(
                      fontWeight: FontWeight.bold,fontSize: 17
                      ),),onTap: () {
                      FetchLocationCubit. get(context).DeleteLocation(location.id);
